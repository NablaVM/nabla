...
<testsize:
    ...
    size r9 gs     ; Get the size of gs, and store in r9 (should be 5)
    size r9 ls     ; Should be 0 

    push ls r0
    push ls r0

    size r9 ls     ; Should be 2

    pop r0 ls 
    
    size r9 ls     ; Should be 1
>
...
<testregrefgs:
    ...
    ldb r9 r4(gs) ; Load the 0th item from global stack (should be constant 'test')
    ...
    ldb r9 $4(gs) ; Should get 33 from gs
>
...
<testregrefls:
    ...
    ldb r9 r0(ls) ; Load index 2 (spot 3) into rll -> Should be 45
    ldb r9 $2(ls) ; Load index 2 (spot 3) into rll -> Should be 45

    mov r0 $3
    ldb r9 r0(ls) ; Load index 2 (spot 3) into rll -> Should be 99
    ldb r9 $3(ls) ; Should be 99
>