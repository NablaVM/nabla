...
TEST(ConstantTests, integers)
{
    ...
    for(uint8_t j = 0; j < 50; j++)
    {
        ...
        std::vector<uint8_t> actual = byteGen.createConstantInt(val, NABLA::Bytegen::Integers::SIXTEEN);
    ...
    for(uint8_t j = 0; j < 50; j++)
    {
        ...
        std::vector<uint8_t> actual = byteGen.createConstantInt(val, NABLA::Bytegen::Integers::THIRTY_TWO);
    ...
    for(uint8_t j = 0; j < 50; j++)
    {
        ...
        std::vector<uint8_t> actual = byteGen.createConstantInt(val, NABLA::Bytegen::Integers::SIXTY_FOUR);
